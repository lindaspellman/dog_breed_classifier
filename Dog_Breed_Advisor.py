...
def main():
    ...
    if preferences_submitted:
        ...
        st.dataframe(rec_url1, hide_index=True, use_container_width=True)
        
        rec_url2 = pd.DataFrame({'breed': [breed_rec2[0]], 'url': breed_url2})
        st.dataframe(rec_url2, hide_index=True, use_container_width=True)
        
        rec_url3 = pd.DataFrame({'breed': [breed_rec3[0]], 'url': breed_url3})
        st.dataframe(rec_url3, hide_index=True, use_container_width=True)
        
        rec_url4 = pd.DataFrame({'breed': [breed_rec4[0]], 'url': breed_url4})
        st.dataframe(rec_url4, hide_index=True, use_container_width=True)

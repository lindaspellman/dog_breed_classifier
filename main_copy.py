...
<style>
    ...
    * {
    ...
    .st-emotion-cache-13k62yr {
        # color: #ff6699; /* changes the text color of the re-run ect text in the developer bar at the top of the window which will not be shown after the application is deployed. Not useful for deployment. */
...
def predict_five_dog_breed_recs(size, num_dogs_had, home_size, alone_dogs, sensitivity, cold_weather, hot_weather, child_friendly, dog_friendly, stranger_friendly, shedding_amount, drooling_potential, groom_ease, weight_gain_potential, trainability, intelligence, mouthiness, prey_drive, barking, wanderlust_potential, en_lvl, intensity, ex_needs, playfulness):
    breed_recs = [
    predict_optimal_dog_breed(size, num_dogs_had, home_size, alone_dogs, sensitivity, cold_weather, hot_weather, child_friendly, dog_friendly, stranger_friendly, shedding_amount, drooling_potential, groom_ease, weight_gain_potential, trainability, intelligence, mouthiness, prey_drive, barking, wanderlust_potential, en_lvl, intensity, ex_needs, playfulness)
    ]
    return breed_recs
...
def main():
    ...
    if preferences_submitted:
        ...
        # breed_rec = predict_optimal_dog_breed(size, num_dogs_had, home_size, alone_dogs, sensitivity, cold_weather, hot_weather, child_friendly, dog_friendly, stranger_friendly, shedding_amount, drooling_potential, groom_ease, weight_gain_potential, trainability, intelligence, mouthiness, prey_drive, barking, wanderlust_potential, en_lvl, intensity, ex_needs, playfulness)
        ...
        # breed_rec2 = predict_optimal_dog_breed(size
        ...
        # breed_rec3 = predict_optimal_dog_breed(size
        #                                     +random_choice_between(-1,1)
        #                                     , num_dogs_had
        #                                     +random_choice_between(-1,1)
        #                                     , home_size
        ...
        # breed_rec4 = predict_optimal_dog_breed(size
        #                                     +random_choice_between(-1,1)
        #                                     , num_dogs_had
        #                                     +random_choice_between(-1,1)
        #                                     , home_size
        ...
        # breed_rec5 = predict_optimal_dog_breed(size
        #                                     +random_choice_between(-1,1)
        #                                     , num_dogs_had
        #                                     +random_choice_between(-1,1)
        #                                     , home_size
